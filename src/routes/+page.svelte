...
<main class="">
	...
	<section class="mx-3 sm:mx-6 md:mx-[5rem] mx-6 flex md:justify-between flex-wrap mt-10 justify-items-stretch">
		...
		<!-- overlapping images -->
		<section class="flex w-screen justify-between md:w-[50%] h-auto my-4 md:grid grid-cols-4 grid-rows-4 bg-contain">
	...
	<section class="bg-[#E1E1E1]">
		...
		<section class="mx-3 sm:mx-6 md:mx-[5rem] mx-6">
			<h3 class="text-4xl md:text-5xl font-semibold block my-8 pt-8">The future of health</h3>
			<div class="flex flex-wrap md:justify-between items-start my-12 ">
				<div class="flex flex-col md:max-w-[45%] items-start min-w-screen">
					<img class="h-[80px] w-auto mb-4" src="/assets/ai-brain-logo.svg" alt="brain representing Artificial Intelligence">
					<p class="text-lg md:text-xl">Pioneering the future of healthcare through advanced data analytics, machine learning, and artificial intelligence. Recognizing the transformative power of artificial intelligence, we are charting the course for a healthcare landscape powered by the limitless potential of artificial intelligence.</p>
				</div>
				<div class="flex flex-col md:max-w-[45%] items-start min-w-screen mt-4 md:mt-0">
		...
		<!-- values section -->
		<section class="my-8 mx-3 sm:mx-6 md:mx-[5rem] mx-6">
